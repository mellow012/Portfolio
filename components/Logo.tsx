...
export function MellowverseLogo({
  ...
  return (
    ...
    >
      ...
      >
        {/* Outer glow */}
        <div className="absolute -inset-3 bg-gradient-to-r from-[#c0c1ff]/30 via-[#8083ff]/30 to-[#494bd6]/30 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />

        {/* Main container */}
        <div className="relative w-14 h-14 bg-[#101415]/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-[#464554]/50 flex items-center justify-center overflow-hidden">
          {/* Animated M → ∞ path */}
